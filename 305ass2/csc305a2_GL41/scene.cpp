    ...
    std::vector<uint32_t>* loadedMeshIDs)
{
    ...
    std::map<std::string, uint32_t> MapCache;
    ...
    for (const tinyobj::material_t& materialToAdd : materials)
    {
        ...
        {
            auto cachedTexture = MapCache.find(materialToAdd.diffuse_texname);

            if (cachedTexture != end(MapCache))
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    MapCache.emplace(materialToAdd.diffuse_texname, newDiffuseMapID);
        ...
        {
            auto cachedTexture = MapCache.find(materialToAdd.specular_texname);
            ...
            else
            {
                ...
                else
                {
                    ...
                    MapCache.emplace(materialToAdd.specular_texname, newSpecularMapID);
    ...
    //BumpMaps
        ...
        {
            auto cachedTexture = MapCache.find(materialToAdd.bump_texname);
            ...
            else
            {
                ...
                else
                {
                    ...
                    MapCache.emplace(materialToAdd.bump_texname, newBumpMapID);
        ...
        {
            auto cachedTexture = MapCache.find(materialToAdd.alpha_texname);
            ...
            else
            {
                ...
                else
                {
                    ...
                    MapCache.emplace(materialToAdd.alpha_texname, newAlphaMaskID);
